    ...
    <MainLayout title="User Management">
        ...
        <el-dialog v-model="dialogFormVisible" width="500px" :append-to-body="true" :destroy-on-close="true"
            ...
            <el-form ref="formUserRef" :model="formUser" label-width="200px" label-position="top"
                ...
                <el-form-item :error="getFormError('role')" prop="role" label="Role">
...
<el-form-item 
  v-if="!formUser.role.includes('SVPoperasi') && !formUser.role.includes('VPkeamanan') && !formUser.role.includes('Dataadmin')"  
  :error="getFormError('ms_komparteman_id')" prop="ms_komparteman_id" label="Kompartemen / Compartment" :required="true">
    <el-select v-model="formUser.ms_komparteman_id" placeholder="Select" class="!w-full">
      <el-option
  ...
  <el-form-item 
  v-if="!formUser.role.includes('SVPoperasi') && !formUser.role.includes('VPkeamanan') && !formUser.role.includes('Dataadmin')" 
  :error="getFormError('ms_departeman_id')" prop="ms_departeman_id" label="Departemen / Department" :required="true">
    <el-select v-model="formUser.ms_departeman_id" placeholder="Select" class="!w-full">
      <el-option
        v-for="departemen in departemens.filter(departemen => departemen.ms_komparteman_id === formUser.ms_komparteman_id)"
...
function addUserAction() {
    ...
    formUser.name = '';
    formUser.npk = '';
    formUser.ms_komparteman_id = '';
    formUser.ms_departeman_id = '';
    formUser.email = '';
    formUser.password = '';
    formUser.role = [];
}
...
function editUserAction(dataUser) {
    ...
    formUser.ms_komparteman_id = dataUser.ms_komparteman_id;
    formUser.ms_departeman_id = dataUser.ms_departeman_id;
